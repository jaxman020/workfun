    ...
    <div id="wrapper">
        ...
        <div id="menu">
			<ul>
				...
				<li class="current_page_item"><a href="employees.php" ><img class="menu" src="images/group.png">&nbsp;&nbsp;&nbsp;員工資料</a></li>
        ...
        <div id="three"> 
            ...
            <section id="block">
                ...
                <span onclick="getData('insert_e_text.php');"><a class="button button1">新增e</a></span>
				<form action="select_employees.php" method="post">
