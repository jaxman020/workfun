    ...
    <div id="wrapper">
        ...
        <div id="header">
            <div id="logo">
                ...
                <h3 id="e"><input name='delete' type='button' class='b2 button6' value='登出' onclick="if (window.confirm('確定要登出嗎?'))location.href='logout.php'"></h3>
            </div>
        </div>
       
        <div id="menu">
			<ul>
				<li class="current_page_item"><a href="manager.php" target="content" ><img class="menu" src="images/phone-book.png">&nbsp;&nbsp;&nbsp;管理人員</a></li>
				...
				<li><a href="board.php" target="content"><img class="menu" src="images/push-pin.png" >&nbsp;&nbsp;&nbsp;公告管理</a></li>
        ...
        <div id="three"> 
            ...
            <section id="block">
                <span onclick="getData('insert_m_text.php');"><a class="button button1">新增m</a></span>
            <form action="select_manager.php" method="post">
            <input id="search"  class="form-control" name="keyword" type="Text" placeholder="search..">
		    </form>
			</section>
