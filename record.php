    ...
    <div id="wrapper">
        ...
        <div id="menu">
			<ul>
				...
				<li class="current_page_item"><a href="record.php" target="content"><img class="menu" src="images/placeholder.png" >&nbsp;&nbsp;&nbsp;打卡紀錄</a></li>
        ...
        <div id="three"> 
            ...
            <section id="block">
            <span onclick="getData('insert_r_text.php');"><a class="button button1">新增打卡紀錄</a></span>
			<span onclick="getData('record_total.php');"><a class="b3 button1">員工時數</a></span>
			
			<form action="select_record.php" method="post">
